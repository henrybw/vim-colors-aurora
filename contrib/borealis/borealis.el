...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(region ((,class (:foreground unspecified :background ,region))))
   `(secondary-selection ((,class (:foreground unspecified :background ,region))))
   `(linum ((,class (:foreground ,linum :background unspecified))))
   `(fringe ((,class (:background unspecified :foreground ,fg4))))
   `(cursor ((,class (:background ,cursor))))
   `(show-paren-match-face ((,class (:background ,matchparen))))
   `(sp-pair-overlay-face ((,class (:background unspecified))))
   ...
   `(mode-line-highlight ((,class (:foreground ,keyword :box unspecified))))
   ...
   `(diff-changed ((,class (:foreground unspecified))))
   ...
   `(term ((,class (:foreground ,fg1 :background unspecified))))
   ...
   `(magit-item-highlight ((,class :background unspecified)))
   ...
   `(magit-hunk-heading           ((,class (:background unspecified))))
   `(magit-hunk-heading-highlight ((,class (:background unspecified))))
   `(magit-diff-file-header ((,class (:foreground ,fg2 :background ,bg3))))
   `(magit-diff-added ((,class (:background unspecified :foreground ,diffadd-fg))))
   `(magit-diff-added-highlight ((,class (:background unspecified :foreground ,diffadd-fg))))
   `(magit-diff-removed ((,class (:background unspecified :foreground ,diffdel-fg))))
   `(magit-diff-removed-highlight ((,class (:background unspecified :foreground ,diffdel-fg))))
   `(magit-diff-context ((,class (:background unspecified :foreground ,fg3))))
   `(magit-diff-context-highlight ((,class (:background unspecified :foreground ,fg1))))
   ...
   `(helm-header ((,class (:foreground ,fg2 :background unspecified :underline unspecified :box unspecified))))
   `(helm-source-header ((,class (:foreground ,keyword :background unspecified :underline unspecified :weight bold))))
   `(helm-selection ((,class (:background ,bg2 :underline unspecified))))
   `(helm-selection-line ((,class (:background ,bg2))))
   `(helm-visible-mark ((,class (:foreground unspecified :background ,bg3))))
   `(helm-candidate-number ((,class (:foreground unspecified :background ,fg1))))
   `(helm-separator ((,class (:foreground ,type :background unspecified))))
   `(helm-time-zone-current ((,class (:foreground ,builtin :background unspecified))))
   `(helm-time-zone-home ((,class (:foreground ,type :background unspecified))))
   `(helm-buffer-not-saved ((,class (:foreground ,type :background unspecified))))
   `(helm-buffer-process ((,class (:foreground ,builtin :background unspecified))))
   `(helm-buffer-saved-out ((,class (:foreground ,fg1 :background unspecified))))
   `(helm-buffer-size ((,class (:foreground ,fg1 :background unspecified))))
   `(helm-ff-directory ((,class (:foreground ,func :background unspecified :weight bold))))
   `(helm-ff-file ((,class (:foreground ,fg1 :background unspecified :weight normal))))
   `(helm-ff-executable ((,class (:foreground ,key2 :background unspecified :weight normal))))
   `(helm-ff-invalid-symlink ((,class (:foreground ,key3 :background unspecified :weight bold))))
   `(helm-ff-symlink ((,class (:foreground ,keyword :background unspecified :weight bold))))
   `(helm-ff-prefix ((,class (:foreground unspecified :background ,keyword :weight normal))))
   `(helm-grep-cmd-line ((,class (:foreground ,fg1 :background unspecified))))
   `(helm-grep-file ((,class (:foreground ,fg1 :background unspecified))))
   `(helm-grep-finish ((,class (:foreground ,fg2 :background unspecified))))
   `(helm-grep-lineno ((,class (:foreground ,fg1 :background unspecified))))
   `(helm-grep-match ((,class (:foreground unspecified :background unspecified :inherit helm-match))))
   `(helm-grep-running ((,class (:foreground ,func :background unspecified))))
   `(helm-moccur-buffer ((,class (:foreground ,func :background unspecified))))
